...
public class WingsWeatherOpenHelper extends SQLiteOpenHelper {
	...
	public WingsWeatherOpenHelper(Context context, String name, CursorFactory factory, int version) {
